const VertexShader = `
  ...
  varying vec3 vPos; // Corrected varying variable

  void main() {
    vec4 modelPosition = modelMatrix * vec4(position, 1.0);

    vPos = modelPosition.xyz; // Pass position to the fragment shader
